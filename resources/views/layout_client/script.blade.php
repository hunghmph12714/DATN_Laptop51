 ...
 <script type="text/javascript" src="{{ asset('client') }}/script/revolution/jquery.themepunch.revolution.min.js">
 </script>
 <script type="text/javascript" src="{{ asset('client') }}/script/revolution/jquery.themepunch.tools.min.js"></script>
 <script type="text/javascript"
  src="{{ asset('client') }}/script/revolution/extensions/revolution.extension.actions.min.js"></script>
 <script type="text/javascript"
  src="{{ asset('client') }}/script/revolution/extensions/revolution.extension.carousel.min.js"></script>
 <script type="text/javascript"
  src="{{ asset('client') }}/script/revolution/extensions/revolution.extension.kenburn.min.js"></script>
 <script type="text/javascript"
  src="{{ asset('client') }}/script/revolution/extensions/revolution.extension.layeranimation.min.js"></script>
 <script type="text/javascript"
  src="{{ asset('client') }}/script/revolution/extensions/revolution.extension.migration.min.js"></script>
 <script type="text/javascript"
  src="{{ asset('client') }}/script/revolution/extensions/revolution.extension.navigation.min.js"></script>
 <script type="text/javascript"
  src="{{ asset('client') }}/script/revolution/extensions/revolution.extension.parallax.min.js"></script>
 <script type="text/javascript"
  src="{{ asset('client') }}/script/revolution/extensions/revolution.extension.slideanims.min.js"></script>
 <script type="text/javascript"
  src="{{ asset('client') }}/script/revolution/extensions/revolution.extension.video.min.js"></script>
