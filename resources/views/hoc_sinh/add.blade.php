    ...
    <div class="card row">
        <div class="col-6">
            <div class="form-group mt-2">
                ...
                <input type="text" name="ma_sv" value="{{old('ma_sv')}}" class="form-control" placeholder="">
                @error('ma_sv')
            ...
            <div class="form-group mt-2">
                ...
                <input type="text" name="que_quan" value="{{old('que_quan')}}" class="form-control"
            ...
            <div class="form-group mt-2">
                ...
                <input type="text" name="dien_thoai" value="{{old('dien_thoai')}}" class="form-control"
            ...
            <div class="form-group mt-2">
                ...
                <select class="form-control" name="ma_lop" id="">
                    ...
                    <option value="{{ $class->id }}"> {{ $class->ma_lop ." - " .$class->ten_lop}}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group mt-2">
                <label for="">Ảnh</label>
                <input type="file" name="anh" value="{{old('anh')}}" class="form-control" placeholder="">
                @error('anh')
                <small class="text-danger"> {{ $message }}</small>
                @enderror
            </div>
